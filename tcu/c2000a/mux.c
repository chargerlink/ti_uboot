...
//stone++ for beep
static struct module_pin_mux gpio1_28_pin_mux[] = {
	{OFFSET(gpmc_be1n), (MODE(7) | PULLDOWN_EN)},	/* GPIO1_28 */
	{-1},
};
...
void enable_board_pin_mux(struct am335x_baseboard_id *header)
{
	...
	configure_module_pin_mux(gpio1_28_pin_mux);//stone++
	
	/* Do board-specific muxes. */
	/* modified by hech @2015-01-05 */
	if (board_is_bone(header)) {
//	if (board_is_bone(header) || board_is_qy(header)) {
		/* Beaglebone pinmux */
